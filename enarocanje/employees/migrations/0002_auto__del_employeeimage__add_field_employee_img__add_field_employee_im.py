...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'employees_employee', 'img',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.img_width'
        db.add_column(u'employees_employee', 'img_width',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Adding field 'Employee.img_height'
        db.add_column(u'employees_employee', 'img_height',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'employees_employee', 'img')

        # Deleting field 'Employee.img_width'
        db.delete_column(u'employees_employee', 'img_width')

        # Deleting field 'Employee.img_height'
        db.delete_column(u'employees_employee', 'img_height')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 8, 0, 0)'}),
