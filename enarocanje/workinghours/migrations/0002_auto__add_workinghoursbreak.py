...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        ('working_hours', self.gf('django.db.models.fields.related.ForeignKey')(related_name='breaks',
                                                                                to=orm['workinghours.WorkingHours'])),
    ...
    'time_from': ('django.db.models.fields.TimeField', [], {}),
    'time_to': ('django.db.models.fields.TimeField', [], {}),
    'working_hours': ('django.db.models.fields.related.ForeignKey', [],
                      {'related_name': "'breaks'", 'to': u"orm['workinghours.WorkingHours']"})
    },
