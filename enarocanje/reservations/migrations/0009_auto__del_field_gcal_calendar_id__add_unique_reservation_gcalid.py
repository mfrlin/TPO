...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Deleting field 'GCal.calendar_id'
        db.delete_column(u'reservations_gcal', 'calendar_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'GCal.calendar_id'
        db.add_column(u'reservations_gcal', 'calendar_id',
