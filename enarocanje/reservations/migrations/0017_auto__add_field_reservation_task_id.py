...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.task_id'
        db.add_column(u'reservations_reservation', 'task_id',
                      self.gf('django.db.models.fields.CharField')(max_length=256, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.task_id'
        db.delete_column(u'reservations_reservation', 'task_id')
