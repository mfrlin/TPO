...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Changing field 'GCal.service_provider'
		db.alter_column(u'reservations_gcal', 'service_provider_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accountext.ServiceProvider'], unique=True))
		# Adding unique constraint on 'GCal', fields ['service_provider']
		db.create_unique(u'reservations_gcal', ['service_provider_id'])

	def backwards(self, orm):
		# Removing unique constraint on 'GCal', fields ['service_provider']
		db.delete_unique(u'reservations_gcal', ['service_provider_id'])

		# Changing field 'GCal.service_provider'
		db.alter_column(u'reservations_gcal', 'service_provider_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountext.ServiceProvider']))
	...
	models = {
		...
		u'reservations.gcal': {
			...
			u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
			'service_provider': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['accountext.ServiceProvider']", 'unique': 'True'})
		},
