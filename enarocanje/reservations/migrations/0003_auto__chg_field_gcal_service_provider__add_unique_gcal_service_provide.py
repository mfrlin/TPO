...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'reservations_gcal', 'service_provider_id',
                        self.gf('django.db.models.fields.related.OneToOneField')(to=orm['accountext.ServiceProvider'],
                                                                                 unique=True))
    ...
    u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
    'service_provider': (
    'django.db.models.fields.related.OneToOneField', [], {'to': u"orm['accountext.ServiceProvider']", 'unique': 'True'})
    },
