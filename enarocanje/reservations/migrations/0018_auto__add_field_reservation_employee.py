...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Reservation.employee'
        db.add_column(u'reservations_reservation', 'employee',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['employees.Employee'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Reservation.employee'
        db.delete_column(u'reservations_reservation', 'employee_id')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 17, 0, 0)'}),
