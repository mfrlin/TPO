...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Reservation.is_confirmed'
        db.add_column(u'reservations_reservation', 'is_confirmed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Reservation.is_confirmed'
        db.delete_column(u'reservations_reservation', 'is_confirmed')
    ...
    'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 29, 0, 0)'}),
