...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Reservation.emailsent'
        db.add_column(u'reservations_reservation', 'emailsent',
    ...
    def backwards(self, orm):
        # Deleting field 'Reservation.emailsent'
        db.delete_column(u'reservations_reservation', 'emailsent')
    ...
    'referral': ('django.db.models.fields.related.ForeignKey', [],
                 {'to': u"orm['accountext.User']", 'null': 'True', 'on_delete': 'models.SET_NULL', 'blank': 'True'}),
    ...
    'service': ('django.db.models.fields.related.ForeignKey', [],
                {'to': u"orm['service.Service']", 'null': 'True', 'on_delete': 'models.SET_NULL'}),
