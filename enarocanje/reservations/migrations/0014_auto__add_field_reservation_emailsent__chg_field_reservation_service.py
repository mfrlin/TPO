...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		db.alter_column(u'reservations_reservation', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.Service'], null=True, on_delete=models.SET_NULL))
