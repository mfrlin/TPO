...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		db.alter_column(u'reservations_reservation', 'gcalid', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True))

	def backwards(self, orm):

		# Changing field 'Reservation.gcalid'
		db.alter_column(u'reservations_reservation', 'gcalid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=128, null=True))
