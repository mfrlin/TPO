...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Reservation.isfromgcal'
        db.add_column(u'reservations_reservation', 'isfromgcal',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Reservation.user_fullname'
        db.add_column(u'reservations_reservation', 'user_fullname',
                      self.gf('django.db.models.fields.CharField')(max_length=60, null=True),
                      keep_default=False)

        # Adding field 'Reservation.user_phone'
        db.add_column(u'reservations_reservation', 'user_phone',
                      self.gf('django.db.models.fields.PositiveIntegerField')(max_length=100, null=True),
                      keep_default=False)

        # Adding field 'Reservation.user_email'
        db.add_column(u'reservations_reservation', 'user_email',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Reservation.isfromgcal'
        db.delete_column(u'reservations_reservation', 'isfromgcal')

        # Deleting field 'Reservation.user_fullname'
        db.delete_column(u'reservations_reservation', 'user_fullname')

        # Deleting field 'Reservation.user_phone'
        db.delete_column(u'reservations_reservation', 'user_phone')

        # Deleting field 'Reservation.user_email'
        db.delete_column(u'reservations_reservation', 'user_email')
    ...
    'gcalid': ('django.db.models.fields.CharField', [], {'max_length': '128', 'unique': 'True', 'null': 'True'}),
    ...
    'user_phone': ('django.db.models.fields.PositiveIntegerField', [], {'max_length': '100', 'null': 'True'})
    },
    u'service.category': {
    'Meta': {'object_name': 'Category'},
    u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
