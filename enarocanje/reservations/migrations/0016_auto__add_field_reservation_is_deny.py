...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Reservation.is_deny'
        db.add_column(u'reservations_reservation', 'is_deny',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Reservation.is_deny'
        db.delete_column(u'reservations_reservation', 'is_deny')
    ...
    'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 2, 0, 0)'}),
