...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		db.alter_column(u'reservations_reservation', 'user_phone', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

	def backwards(self, orm):

		# Changing field 'Reservation.user_phone'
		db.alter_column(u'reservations_reservation', 'user_phone', self.gf('django.db.models.fields.PositiveIntegerField')(max_length=100, null=True))
