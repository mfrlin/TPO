...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		db.add_column(u'reservations_reservation', 'service_provider',
					  self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='reservations', to=orm['accountext.ServiceProvider']),
					  keep_default=False)
		...
		db.alter_column(u'reservations_reservation', 'service_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['service.Service'], null=True))
