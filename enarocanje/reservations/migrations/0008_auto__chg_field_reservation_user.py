...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'Reservation.user'
        db.alter_column(u'reservations_reservation', 'user_id',
                        self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountext.User'], null=True))

    def backwards(self, orm):
        # User chose to not deal with backwards NULL issues for 'Reservation.user'
        raise RuntimeError("Cannot reverse this migration. 'Reservation.user' and its values cannot be restored.")
