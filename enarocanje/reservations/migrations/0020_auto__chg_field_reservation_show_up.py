...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reservation.show_up'
        db.alter_column(u'reservations_reservation', 'show_up', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'Reservation.show_up'
        db.alter_column(u'reservations_reservation', 'show_up', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'reservations.reservation': {
            ...
            'show_up': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
