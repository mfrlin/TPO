...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.add_column(u'coupon_coupon', 'service',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=True, related_name='serviceCoupon',
                                                                            to=orm['service.Service']),
                      keep_default=False)
    ...
    'service': ('django.db.models.fields.related.ForeignKey', [],
                {'default': 'True', 'related_name': "'serviceCoupon'", 'to': u"orm['service.Service']"}),
