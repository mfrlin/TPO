...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'Coupon.is_used'
        db.add_column(u'coupon_coupon', 'is_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Coupon.is_used'
        db.delete_column(u'coupon_coupon', 'is_used')
    ...
    'service': (
    'django.db.models.fields.related.ForeignKey', [], {'related_name': "'coupons'", 'to': u"orm['service.Service']"}),
    'service_provider': ('django.db.models.fields.related.ForeignKey', [],
                         {'related_name': "'coupons'", 'to': u"orm['accountext.ServiceProvider']"}),
