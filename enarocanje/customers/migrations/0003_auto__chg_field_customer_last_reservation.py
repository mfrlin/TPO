...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'customers_customer', 'last_reservation', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 11, 0, 0)'}),
        ...
        u'customers.customer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_reservation': ('django.db.models.fields.DateField', [], {}),
