...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Customer', fields ['service', 'email']
        db.create_unique(u'customers_customer', ['service_id', 'email'])


    def backwards(self, orm):
        # Removing unique constraint on 'Customer', fields ['service', 'email']
        db.delete_unique(u'customers_customer', ['service_id', 'email'])
