...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Customer.user_id'
        db.delete_column(u'customers_customer', 'user_id_id')

        # Adding field 'Customer.user'
        db.add_column(u'customers_customer', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountext.User'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Customer.user_id'
        db.add_column(u'customers_customer', 'user_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accountext.User'], null=True),
                      keep_default=False)

        # Deleting field 'Customer.user'
        db.delete_column(u'customers_customer', 'user_id')
    ...
    models = {
        ...
        u'customers.customer': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_reservation': ('django.db.models.fields.DateTimeField', [], {}),
