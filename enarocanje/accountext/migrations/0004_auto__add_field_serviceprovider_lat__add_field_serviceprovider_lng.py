...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		# Adding field 'ServiceProvider.lat'
		db.add_column(u'accountext_serviceprovider', 'lat',
					  self.gf('django.db.models.fields.FloatField')(null=True),
					  keep_default=False)

		# Adding field 'ServiceProvider.lng'
		db.add_column(u'accountext_serviceprovider', 'lng',
					  self.gf('django.db.models.fields.FloatField')(null=True),
					  keep_default=False)

	def backwards(self, orm):
		# Deleting field 'ServiceProvider.lat'
		db.delete_column(u'accountext_serviceprovider', 'lat')

		# Deleting field 'ServiceProvider.lng'
		db.delete_column(u'accountext_serviceprovider', 'lng')
