...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accountext_subscription', (
        ...
        db.send_create_signal(u'accountext', ['Subscription'])


    def backwards(self, orm):
        # Deleting model 'Subscription'
        db.delete_table(u'accountext_subscription')
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscribers': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['accountext.User']", 'through': u"orm['accountext.Subscription']", 'symmetrical': 'False'}),
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 1, 0, 0)'}),
