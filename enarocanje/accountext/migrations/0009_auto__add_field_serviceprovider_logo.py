...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		# Adding field 'ServiceProvider.logo'
		db.add_column(u'accountext_serviceprovider', 'logo',
					  self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
					  keep_default=False)

	def backwards(self, orm):
		# Deleting field 'ServiceProvider.logo'
		db.delete_column(u'accountext_serviceprovider', 'logo')
