...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		# Adding field 'ServiceProvider.logo_width'
		db.add_column(u'accountext_serviceprovider', 'logo_width',
					  self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
					  keep_default=False)

		# Adding field 'ServiceProvider.logo_height'
		db.add_column(u'accountext_serviceprovider', 'logo_height',
					  self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
					  keep_default=False)

	def backwards(self, orm):
		# Deleting field 'ServiceProvider.logo_width'
		db.delete_column(u'accountext_serviceprovider', 'logo_width')

		# Deleting field 'ServiceProvider.logo_height'
		db.delete_column(u'accountext_serviceprovider', 'logo_height')
