...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding field 'User.premium'
        db.add_column(u'accountext_user', 'premium',
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 5, 28, 0, 0)'}),
