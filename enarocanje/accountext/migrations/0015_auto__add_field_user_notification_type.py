...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.notification_type'
        db.add_column(u'accountext_user', 'notification_type',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.notification_type'
        db.delete_column(u'accountext_user', 'notification_type')
