...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceProvider.display_generic_gallery'
        db.alter_column(u'accountext_serviceprovider', 'display_generic_gallery', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'ServiceProvider.display_generic_gallery'
        db.alter_column(u'accountext_serviceprovider', 'display_generic_gallery', self.gf('django.db.models.fields.BooleanField')(default=None))
