...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Adding field 'ServiceProvider.timezone'
        db.add_column(u'accountext_serviceprovider', 'timezone',
                      self.gf('django.db.models.fields.CharField')(default='en', max_length=10),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'ServiceProvider.timezone'
        db.delete_column(u'accountext_serviceprovider', 'timezone')
    ...
    'timezone': ('django.db.models.fields.CharField', [], {'default': "'en'", 'max_length': '10'}),
