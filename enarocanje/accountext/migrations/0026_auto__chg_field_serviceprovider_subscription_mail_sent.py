...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceProvider.subscription_mail_sent'
        db.alter_column(u'accountext_serviceprovider', 'subscription_mail_sent', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'ServiceProvider.subscription_mail_sent'
        db.alter_column(u'accountext_serviceprovider', 'subscription_mail_sent', self.gf('django.db.models.fields.BooleanField')(default=None))
