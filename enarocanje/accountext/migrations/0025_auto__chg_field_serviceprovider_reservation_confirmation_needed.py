...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceProvider.reservation_confirmation_needed'
        db.alter_column(u'accountext_serviceprovider', 'reservation_confirmation_needed', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'ServiceProvider.reservation_confirmation_needed'
        db.alter_column(u'accountext_serviceprovider', 'reservation_confirmation_needed', self.gf('django.db.models.fields.BooleanField')(default=None))
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 27, 0, 0)'}),
