...
class Migration(SchemaMigration):
    def forwards(self, orm):
        # Changing field 'ServiceProvider.timezone'
        db.alter_column(u'accountext_serviceprovider', 'timezone',
    ...
    models = {
        ...
        u'accountext.serviceprovider': {
            ...
            'subscription_end_date': (
                'django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 0, 0)'}),
        ...
        u'accountext.serviceproviderimage': {
            ...
            'service_provider': (
            'django.db.models.fields.related.ForeignKey', [], {'to': u"orm['accountext.ServiceProvider']"})
        },
        u'accountext.user': {
            ...
            'referral': ('django.db.models.fields.related.ForeignKey', [],
                         {'to': u"orm['accountext.User']", 'null': 'True', 'on_delete': 'models.SET_NULL',
                          'blank': 'True'}),
