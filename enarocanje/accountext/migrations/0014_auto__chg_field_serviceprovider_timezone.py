...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		db.alter_column(u'accountext_serviceprovider', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=30))

	def backwards(self, orm):

		# Changing field 'ServiceProvider.timezone'
		db.alter_column(u'accountext_serviceprovider', 'timezone', self.gf('django.db.models.fields.CharField')(max_length=10))
	...
	models = {
		...
		u'accountext.serviceprovider': {
			...
			'subscription_end_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 0, 0)'}),
