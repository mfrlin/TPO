...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Changing field 'Service.discount'
		db.alter_column(u'service_service', 'discount', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

	def backwards(self, orm):

		# Changing field 'Service.discount'
		db.alter_column(u'service_service', 'discount', self.gf('django.db.models.fields.DateField')(null=True))
