...
class Migration(SchemaMigration):
    def forwards(self, orm):
        ...
        db.alter_column(u'service_discount', 'discount',
                        self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Discount.valid_from'
        db.alter_column(u'service_discount', 'valid_from',
                        self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 5, 17, 0, 0)))

        # Changing field 'Discount.valid_to'
        db.alter_column(u'service_discount', 'valid_to',
                        self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 5, 17, 0, 0)))
