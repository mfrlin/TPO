...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Changing field 'Service.price'
		db.alter_column(u'service_service', 'price', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2))

	def backwards(self, orm):

		# Changing field 'Service.price'
		db.alter_column(u'service_service', 'price', self.gf('django.db.models.fields.FloatField')(null=True))
