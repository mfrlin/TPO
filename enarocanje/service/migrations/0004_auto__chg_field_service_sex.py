...
class Migration(SchemaMigration):
	...
	def forwards(self, orm):
		...
		# Changing field 'Service.sex'
		db.alter_column(u'service_service', 'sex', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

	def backwards(self, orm):

		# Changing field 'Service.sex'
		db.alter_column(u'service_service', 'sex', self.gf('django.db.models.fields.CharField')(max_length=1))
